  ...
  <body style="font-family: Trebuchet MS;">
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
	  	<img src="collegelogo.png" alt="attendance" style="width:10%;height:50px;" align="left">&nbsp;

        <a class="navbar-brand" href="#" style="font-family: Trebuchet MS;">THE OXFORD COLLEGE OF SCIENCE</a>
