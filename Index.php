  ...
  <body style="font-family: Trebuchet MS;">
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
	  	<img src="collegelogo.png" alt="attendance" style="width:150px;height:50px;" align="left">&nbsp;

        <a class="navbar-brand" href="#" style="font-family: Trebuchet MS;">THE OXFORD COLLEGE OF SICENCE</a>
...
<div class="container-fluid" style="font-family: Trebuchet MS; font-size:20px;">
      <div class="row">
        ...
        <main role="main" class="col-sm-12 ml-sm-auto col-md-12 pt-3">
          <h5 style="font-family: Trebuchet MS;">WELCOME TO THE OXFORD COLLEGE OF SCIENCE</h5>
